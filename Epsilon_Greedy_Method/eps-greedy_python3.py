...
# For Python 3.x and matplotlib 3.x
# LaTeX is not Required Version
...
for eps in range(len(epsilon)) : 
	...
	fig1.plot(range(0,n_pulls+1),R_eps,col[eps],label = (r"epsilon="+str(epsilon[eps])))
	fig2.plot(range(2,n_pulls+1),R_eps_opt,col[eps],label = (r"epsilon="+str(epsilon[eps])))
